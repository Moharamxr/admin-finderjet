...
const ActionCheckBox: React.FC<ActionCheckBoxProps> = ({
  ...
  return (
    <div
      className={clsx(
        "w-6 h-6 border-gray-200 border-2 rounded-lg bg-white hover:border-green-500 flex items-center justify-center transition-all duration-200",
    ...
    >
      <svg
        ...
        className={clsx("w-4 h-4", !checked && "hidden")}
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
